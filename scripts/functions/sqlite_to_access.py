...
types = {"smallint":"Number", "float":"Number", "double":"Number", "bit":"bit", "integer":"Number", "text":"Text", "real":"Number", "timestamp":"Text", "datetime":"datetime", "time":"datetime"}
...
def convert_sqlite_to_access(path_to_access_db, path_to_sql_db):
    ...
    try:
        ...
        print("yessssssssssssssss ", tables)
        for table in tables:
            print(table)
            s = []
            z = []
...
path_to_sql_db = r"d:\Docs\test\test_celsius\MasterInput.db"
path_to_access_db = r"d:\Docs\test\test_celsius\MasterInput.mdb"

convert_sqlite_to_access(path_to_access_db, path_to_sql_db)